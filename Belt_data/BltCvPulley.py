...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton.setGeometry(QtCore.QRect(80, 295, 75, 23))
        #self.pushButton.setObjectName("pushButton")
        #Import
        self.pushButton2 = QtGui.QPushButton('Import',Dialog)
        self.pushButton2.setGeometry(QtCore.QRect(160, 295, 75, 23))
        #self.pushButton2.setObjectName("pushButton")
        #upDate
        self.pushButton3 = QtGui.QPushButton('upDate',Dialog)
        self.pushButton3.setGeometry(QtCore.QRect(240, 295, 75, 23))
    ...
    def onSpec(self):
        ...
        try:
            if buhin=='DrivePulley' or buhin=='HeadPulley':
                ...
                D=250.0 
            elif buhin=='DrivePulley' or buhin=='HeadPulley':    
                E=float(sa[5])
            else:
                E=0.0
        except:
    ...
    def importData(self):
        ...
        if selected_object.TypeId == "App::Part":
            ...
            for obj in parts_group.Group:
                #print(obj.Label)
                #if obj.Label=='BendPulley':
                #    BendPulley=obj
                self.comboBox_2.setCurrentText(obj.Label)
                self.comboBox.setCurrentText(obj.BeltWidth)
                self.lineEdit_30.setText(str(obj.L))
                self.lineEdit_3.setText(str(obj.A))
                self.lineEdit_6.setText(str(obj.B))
                self.lineEdit_50.setText(str(obj.C))
                self.lineEdit_7.setText(str(obj.D))
                self.lineEdit_8.setText(str(obj.E))
                self.lineEdit_9.setText(str(obj.d1))
                self.lineEdit_10.setText(str(obj.d2))
                self.lineEdit_11.setText(str(obj.d3))
                self.lineEdit_12.setText(str(obj.t1))
                self.lineEdit_13.setText(str(obj.t2))
                self.lineEdit_14.setText(str(obj.t3))
                self.lineEdit_15.setText(str(obj.t4))
    def upDate(self):
        selection = Gui.Selection.getSelection()
        if not selection:
    ...
    def create(self):
        ...
        B0=float(self.comboBox.currentText())
        #obj.addProperty("App::PropertyFloat", "Standard",'Standard').Standard=B0
