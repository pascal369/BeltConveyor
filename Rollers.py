...
belt_buhin=['Carrier','Return','CarrierRoller','ReturnRoller',
            'SideRoller',]
...
class Ui_Dialog(object):
    ...
    def importData(self):
        ...
        if selection:
             ...
             if selected_object.TypeId == "App::Part":
                 ...
                 #self.comboBox_2.currentText()=obj.Label
                 #self.comboBox.currentText() =obj.BeltWidth
    ...
    def create(self):
        ...
        Standard='B='+self.comboBox.currentText() +'  '+self.comboBox_3.currentText() 
        obj.Standard=Standard 
        obj.addProperty("App::PropertyEnumeration", "BeltWidth",'Standard')
