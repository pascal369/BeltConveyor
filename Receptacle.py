...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        joined_path = os.path.join(base, 'Belt_data','png_data',"Receptacle.png")
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", "Receptacle", None))
    ...
    def create(self): 
         ...
         move_target = None
         for o in new_objs:
             if "waterReceptacle"  in o.Label or "waterReceptacle"  in o.Name:
                 move_target = o
                 break
